...
This do file plots the "true" impact of adopting the more efficient irrigation 
technology as a means of illustrating the TWFE bias from the Monte Carlo simulation
*/
